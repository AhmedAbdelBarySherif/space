...
//    });
//    $('.home_section .overlay .home_info').css( 'left', $('.home_section').width()/3 );
    ...
    $('.home_section .overlay .home_info .down').click(function() {
        $('html, body').animate({scrollTop: $('.about').offset().top});
    });
      
    $('.top_contact .bars').click(function(){
        $('.menu').fadeIn(500);
    });
...
//        $(this).css('bottom', '400px');
    ...
    $(window).scroll(function(){
        if( $(this).scrollTop() >= 200 ){
            $('.going_up').css('opacity', '1');
        } else{
            $('.going_up').css('opacity', '0');
        }
    });
});